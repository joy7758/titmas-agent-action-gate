...
class AgentEvidenceAdapter:
    ...
    def _build_subject(self, request_id: str, request: dict[str, Any]) -> dict[str, Any]:
        return {
            "id": f"obj:{request_id}",
            "type": "action-request",
    ...
    def _build_evidence(
        ...
        return {
            "id": f"evidence:{request_id}:{phase}",
            "subject_ref": subject_id,
    ...
    def build_profile(
        ...
        *,
        ...
        profile = {
            ...
            "subject": self._build_subject(request_id, request),
